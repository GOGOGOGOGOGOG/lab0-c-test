...
/* Set prompt string */
void set_prompt(char *p) { prompt = p; }

/* Turn echoing on/off */
void set_echo(bool on) { echo = on ? 1 : 0; }
...
/* Handling of input */
static void init_in() { buf_stack = NULL; }
...
void block_console() { block_flag = true; }
...
bool cmd_done() { return buf_stack == NULL || quit_flag; }
